...
SECRET_KEY = 'django-insecure-mfxp&o*rvgxc#4_#)**yrgk&u$nv6w%x3f1e4%i_trbvvayr0m'
...
# Django will try these backends in order.
...
# Allow your frontend to make requests to the backend
CORS_ALLOWED_ORIGINS = [
    "http://localhost:8080", #Adjust this to your frontend URL
]

# Configure Django REST Framework to use JWT
REST_FRAMEWORK = {
